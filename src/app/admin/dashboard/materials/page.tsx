...
export default function AdminMaterialsPage() {
    const { data: recentMaterials } = getMaterials({ page: 1, limit: 5 });
    ...
    return (
        <div className="grid gap-8 md:grid-cols-3">
            <div className="md:col-span-1">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Add a new file to the course resources.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <MaterialUploadForm />
                    </CardContent>
            ...
            <div className="md:col-span-2">
                <h2 className="text-2xl font-headline font-semibold mb-4">Recent Uploads</h2>
                <Card>
                               ...
                               <li key={m.id} className="p-4 flex items-center space-x-4">
                                   ...
                                   <div className="flex-1">
                                       ...
                                       <p className="text-sm text-muted-foreground">
                                           {m.subject} &middot; {formatDistanceToNow(new Date(m.upload_date), { addSuffix: true })}
                                       </p>
                                   </div>
                               </li>
                           ))}
